...
import { Brand, Logo, Lines, Field } from "./ui";
  ...
  return (
    <nav className="wf-nav">
      ...
      >
        ...
        <a href="#form" className="wf-btn sm primary">
          Hablemos →
        </a>
      </div>
    </nav>
    ...
    <header className="wf-section" data-screen-label="B-hero">
      <div className="wf-wrap splitHero">
        <div>
          ...
          <h1 className="wf-h1">
            Tu negocio, <span className="mark-hl">digitalizado</span>. Sin
            complicaciones.
          </h1>
          <p className="wf-lead">
            Construimos la web, app o sistema que necesitas — desde negocios
            locales hasta grandes proyectos.
          </p>
          <p className="wf-lead wf-en">
            We build the web, app or system you need — from local business to
            enterprise scale.
          </p>
        </div>
        <div className="wf-stack">
          ...
          >
            ...
            <h3 className="wf-h3" style={{ marginTop: 8 }}>
          ...
          <div
            className={
              "wf-box routeCard " + (route === "enterprise" ? "sel" : "dim")
            }
            onClick={() => setRoute("enterprise")}
          >
            <span
              className="wf-chip badge"
    ...
    <section className="wf-section" id="dolor">
      <div className="wf-wrap">
        ...
        <div className="ba mt-lg">
          {/* BEFORE */}
          <div className="col">
            <div className="wf-box tint flat wf-center">
          ...
          {PROJECTS.slice(0, 3).map((p) => (
            <div className="wf-box" key={p.id}>
              ...
              >
                ...
                <span className="wf-muted" style={{ fontSize: 13 }}>
                  {p.year}
                </span>
              </div>
              ...
              <div className="wf-row gap-sm mt" style={{ flexWrap: "wrap" }}>
                {p.tech.map((t) => (
                  <span className="wf-chip" key={t} style={{ fontSize: 12 }}>
                    {t}
                  </span>
                ))}
              </div>
    ...
    <section className="wf-section" id="faq">
      <div className="wf-wrap wf-grid cols-2" style={{ alignItems: "start" }}>
        ...
        <div className="wf-stack">
          {FAQS.map(([q, a], i) => (
            <div
              className={"wf-box flat faqItem" + (open === i ? " open" : "")}
              key={q}
  ...
  return (
    <footer className="wf-foot">
      <div className="wf-wrap wf-grid cols-4">
        <div>
          <Brand size={22} />
          <p className="wf-muted">Software que funciona para tu negocio.</p>
        </div>
        <div className="wf-stack gap-sm">
          <strong>Servicios</strong>
          <span className="wf-muted">Páginas web</span>
          <span className="wf-muted">Apps a medida</span>
          <span className="wf-muted">Automatización</span>
        </div>
        <div className="wf-stack gap-sm">
          <strong>Enterprise</strong>
          <span className="wf-muted">Cloud</span>
          <span className="wf-muted">Legacy</span>
          <span className="wf-muted">Datos & IA</span>
        </div>
        <div className="wf-stack gap-sm">
          <strong>Contacto</strong>
          <span className="wf-muted">ducks.coding.e@gmail.com</span>
          <span className="wf-muted">+52 2721287943</span>
        </div>
      </div>
    </footer>
  );
