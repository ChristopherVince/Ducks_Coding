...
export const SERVICE_OPTIONS = ['Desarrollo de apps', 'Migración a la nube', 'Automatización & IA', 'Modernización legacy', 'Datos & dashboards', 'Consultoría'];
export const BUDGET_OPTIONS = ['< 5.000 €', '5.000 – 20.000 €', '20.000 – 50.000 €', '> 50.000 €'];
